...
public final class MavenNames {
    ...
    public static final String SUREFIRE_INTERCEPTOR_CLASS_VM = "org/urts/maven/SurefireMojoInterceptor";

    // ScalaTest.
    public static final String TESTMOJO_VM = "org/scalatest/tools/maven/TestMojo";
    public static final String SCALATEST_INTERCEPTOR_CLASS_VM = "org/urts/maven/ScalaTestMojoInterceptor";
