...
import org.urts.asm.ClassReader;
import org.urts.asm.ClassVisitor;
import org.urts.asm.ClassWriter;
import org.urts.asm.Label;
import org.urts.asm.MethodVisitor;
import org.urts.asm.Opcodes;

/**
 * {@link ClassFileTransformer} to instrument JUnit to support collecting
 * coverage and finding (non) affected classes.
 */
public class JUnit4ReTestAllCFT implements ClassFileTransformer {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            ...
            if (opcode == Opcodes.INVOKEVIRTUAL && name.equals(JUnitNames.RUNNER_FOR_CLASS_METHOD)
                ...
                mv.visitMethodInsn(Opcodes.INVOKESTATIC,
                        JUnitNames.JUNIT4_RETESTALL_VM,
